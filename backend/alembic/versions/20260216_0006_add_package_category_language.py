...
def upgrade() -> None:
    ...
    op.alter_column("software_packages", "category", nullable=False)
    op.alter_column("software_packages", "language", nullable=False)
    ...
    op.alter_column("upload_sessions", "package_category", nullable=False)
    op.alter_column("upload_sessions", "package_language", nullable=False)
